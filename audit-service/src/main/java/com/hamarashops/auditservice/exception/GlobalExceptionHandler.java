...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(DuplicateAuditException.class)
	public ResponseEntity<ErrorResponse> handleDuplicateAuditException(DuplicateAuditException ex) {
		logger.warn("Duplicate audit conflict: {}", ex.getMessage());
